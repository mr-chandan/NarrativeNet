      ...
      <div className={styles.grid}>
            ...
            {filteredContributions?.map((text, index) => (
              <span
                className={`${styles.contribution} ${
                  showColors
                    ? styles[shuffledColors[index % shuffledColors.length]]
                    : ""
                }`}
                onClick={() => handleContributionClick(text)}
                key={index}
              >
                {text.content}
              </span>
        ...
        <div className={styles.grid2}>
          {selectedContribution ? (
            ...
            <div className={styles.nontselect}>Please select a contribution</div>
          )}
        </div>
      </div>
    </div>
